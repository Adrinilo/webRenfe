          ...
          function ocultarEstaciones() {
            ...
            elements
              ...
              .forEach(element => element.style.display = 'none');
					...
					window.onload = () => {
					  document.getElementById('cont-estacionE-tal').style.display = 'block';
					}
					//]]>
        </script>
				<script>
                ...
                ponemos a su disposición.
                  ...
                  INFORMACION
								...
								<div class="dropdown-menu border-0 bg-transparent" aria-labelledby="btnGroupDrop1">
									<xsl:for-each select="renfe/estaciones/estacion">
										<a class="dropdown-item p-2 my-1 shadow text-white bg-success rounded-pill" href="#" onclick="ocultarEstaciones();document.getElementById('cont-estacion{@id}').style.display = 'block';">
											<xsl:value-of select="nombre" />
										</a>
									</xsl:for-each>
								</div>
